...
// Package testdata holds data used for testing by multiple Monologue packages.
package testdata
...
-----END CERTIFICATE-----`
	...
	// SCT is an SCT for the certificate chain {LeafCertPEM, IntermediateCertPEM, RootCertPEM}
	...
	// LeafHash is the leaf hash for the chain {LeafCertPEM, IntermediateCertPEM, RootCertPEM} with SCT.
	LeafHash = "uvjbEw+porcnNLYkXBSVecJdl7QfuL4SAwZZWobcwHg="

	// TreeSize is the tree size passed to get-proof-by-hash, along with LeafHash, to get GetProofByHashResponseBody.
	TreeSize uint64 = 30

	// GetProofByHashResponseBody is a valid get-proof-by-hash response for LeafHash and TreeSize.
	GetProofByHashResponseBody = `{"leaf_index":10,"audit_path":["pWAVPaJIQdVdHgm/GWo/tf0a0gaG4JjCanqHc49kxpU=","+05OCiIkipWWDKhByJGctdwLiSo1geIvWF8pDGv2VFw=","aBTbMciBy2Ey35az07wjEiFN1kWn+37LVa07BQCH2qo=","t+sKhOFhVnTT/6bmOSyVWKfGagwJBVvcyynO2oJLxsY=","LRdkcLMeof0FdRmX6IVaDTITWJUr8eABhUaHa0vcWNw="]}`
)
